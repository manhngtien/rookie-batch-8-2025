...
namespace AssetManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250528111732_Updated_Assignment_Entity")]
    partial class Updated_Assignment_Entity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AssetManagement.Core.Entities.Assignment", b =>
                {
                    ...
                    b.Property<int?>("ReturningRequestId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ReturningRequestId")
                        .IsUnique()
                        .HasFilter("[ReturningRequestId] IS NOT NULL");
            ...
            modelBuilder.Entity("AssetManagement.Core.Entities.Assignment", b =>
                {
                    ...
                    b.HasOne("AssetManagement.Core.Entities.ReturningRequest", "ReturningRequest")
                        .WithOne("Assignment")
                        .HasForeignKey("AssetManagement.Core.Entities.Assignment", "ReturningRequestId")
                        .OnDelete(DeleteBehavior.Restrict);
